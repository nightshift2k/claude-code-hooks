...
extract_version = release_check.extract_version
...
"""
        ...
        assert "SKIP_RELEASE_CHECK=1" in captured.err

    def test_allows_tag_when_version_in_changelog(self) -> None:
        """Should allow tag when version found in CHANGELOG."""
        input_data = {
            "tool_name": "Bash",
            "tool_input": {"command": "git tag v0.1.4"}
        }
...
"""
    ...
    def test_allows_tag_when_changelog_missing(self) -> None:
        """Should allow tag when CHANGELOG.md doesn't exist."""
        input_data = {
            "tool_name": "Bash",
            "tool_input": {"command": "git tag v0.1.4"}
        }
